...
class Finance extends Model
{
    ...
    public static function add($finance)
    {
        ...
        $new_finance->course_fees = $finance['course_fees'] ?? null;
        $new_finance->first_year_fees = $finance['first_year_fees'] ?? null;
        $new_finance->living_cost_inside_london = $finance['living_cost_inside_london'] ?? null;
        $new_finance->living_cost_outside_london = $finance['living_cost_outside_london'] ?? null;
        $new_finance->total_fund = $finance['total_fund'] ?? null;
        $new_finance->living_cost_plan = $finance['living_cost_plan'] ?? null;
        $new_finance->other = $finance['other'] ?? null;
        $new_finance->education_loan = $finance['education_loan'] ?? null;
        $new_finance->another_education_loan = $finance['another_education_loan'] ?? null;
        $new_finance->fees_deposit = $finance['fees_deposit'] ?? null;
        $new_finance->another_deposit = $finance['another_deposit'] ?? null;
        $new_finance->funds_amount_paid = $finance['funds_amount_paid'] ?? null;
        $new_finance->edu_loan_paid = $finance['edu_loan_paid'] ?? null;
        $new_finance->fees_outstanding = $finance['fees_outstanding'] ?? null;
