                                ...
                                <form method="POST" action="{{ route('students.update', [$student->id]) }}">
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="firstName" name="first_name" value="{{ $student->first_name }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="label" for="middleName">Last Name</label>
                                            <input type="text" name="last_name" value="{{ $student->last_name }}" id="lastName">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nationality" id="email" value="{{ $student->nationality }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="label" for="phone_no">Phone Number <span>*</span></label>
                                            <input type="text" name="phone_no" id="text" value="{{ $student->phone_no }}" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="label" for="phone_no">Date Of Birth <span>*</span></label>
                                            <input type="date" name="date_of_birth" value="{{ $student->date_of_birth }}" id="date_of_birth" required>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="passport" value="{{ $student->passport }}" id="text" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="label">Gender <span>*</span></label>
                                            <div class="radio-btn">
                                                <input type="radio" id="male" name="gender" value="1" {{ $student->gender == 1 ? 'checked' : '' }} required>
