                                    ...
                                    <div class="container-fluid mt-3" style="--bs-gutter-x: 0rem !important;">
                                        <div class="panel">
                                            ...
                                            <div class="collapse-div mb-3">
                                                <div class="row extra-padding">
                                                    <div class="col-md-12 mt-1">
                                                        ...
                                                        <input type="file" id="file1" name="vignette_doc[]" accept="application/pdf" class="file file_style form-control"
                                            ...
                                            <div class="collapse-div mb-3">
                                                <div class="row extra-padding">
                                                    <div class="col-md-12 mt-1">
                                                        <label for="file1" class="pe-1 file-docs label">Copy Of Vignette Stamped (Date Of Entry):</label>
                                                        <input type="file" id="file1" name="vignette_stamp_doc[]" accept="application/pdf" class="file file_style form-control"
                                                            onchange="displayFileNames(this)" data-file-name="file-name1" multiple>
                                                        <label for="file1" class="custom-file-upload">
                                                            <i aria-hidden="true" class="fa fa-upload"></i> Upload Files
                                                        </label>
                                    ...
                                    <div class="container-fluid mt-3" style="--bs-gutter-x: 0rem !important;">
                                        <div class="panel">
                                            ...
                                            <div class="collapse-div mb-3">
                                                <div class="row extra-padding">
                                                    <div class="col-md-12 mt-1">
                                                        <label for="file1" class="pe-1 file-docs label">E-Ticket:</label>
                                                        <input type="file" id="file1" name="e_ticket[]" accept="application/pdf" class="file file_style form-control"
                                                            onchange="displayFileNames(this)" data-file-name="file-name1" multiple>
                                                        <label for="file1" class="custom-file-upload">
                                                            <i aria-hidden="true" class="fa fa-upload"></i> Upload Files
                                                        </label>
                                    ...
                                    <div class="container-fluid mt-3" style="--bs-gutter-x: 0rem !important;">
                                        <div class="panel">
                                            ...
                                            <div class="collapse-div mb-3">
                                                <div class="row extra-padding">
                                                    <div class="col-md-12 mt-1">
                                                        <label for="file1" class="pe-1 file-docs label">Screen Shot SMS Reporting:</label>
                                                        <input type="file" id="file1" name="sms_screen_shot[]" accept="application/pdf" class="file file_style form-control"
                                                            onchange="displayFileNames(this)" data-file-name="file-name1" multiple>
                                                        <label for="file1" class="custom-file-upload">
                                                            <i aria-hidden="true" class="fa fa-upload"></i> Upload Files
                                                        </label>
                                            ...
                                            <div class="collapse-div mb-3">
                                                <div class="row extra-padding">
                                                    <div class="col-md-12 mt-1">
                                                        <label for="file1" class="pe-1 file-docs label">BRP Documents:</label>
                                                        <input type="file" id="file1" name="brp_doc[]" accept="application/pdf" class="file file_style form-control"
                                                            onchange="displayFileNames(this)" data-file-name="file-name1" multiple>
                                                        <label for="file1" class="custom-file-upload">
                                                            <i aria-hidden="true" class="fa fa-upload"></i> Upload Files
                                                        </label>
